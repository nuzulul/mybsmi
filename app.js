...
function fpagecabangrun(content,cabangid)
{
  ...
  var data = '<div class="data-table data-table-collapsible data-table-init"><table><thead><tr><th></th><th>Nama</th><th>No. KTA</th><th>Aktif</th></tr></thead><tbody>';
  var jumlahrelawan = 0;
...
+'    <p class="mybsmi-relawan-data text-align-center"><span style="font-weight:bold;">'+safe(data[3])+'</span><br><span style="font-weight:normal;">No. KTA : '+safe(data[6])+'</span><br><span style="font-weight:normal;">'+safe(data[4])+' | '+safe(data[7])+' Bintang</span><br><span style="font-weight:normal;">Aktif '+safe(date)+'</span><br><br><span><a href="#" class="button button-fill color-red display-none mybsmi-relawan-kirimpesan">Kirim Pesan</a></span><p>';
