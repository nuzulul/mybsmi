...
function flengkapiphoto()
{
  var dialog = app.dialog.create({
    ...
    content: '<div style="width:100%;">'
      +'<p style="text-align:center; border:1px solid gray;padding:10px 10px;color:gray;">Pilih photo resmi direkomendasikan memakai rompi BSMI. Anda tidak dapat melakukan perubahan photo setelah upload!</p>'
